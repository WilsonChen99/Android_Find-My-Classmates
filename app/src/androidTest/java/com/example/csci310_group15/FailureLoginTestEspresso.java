...
@LargeTest
public class FailureLoginTestEspresso {
    public static final String STRING_TO_BE_TYPED_EMAIL = "taco@ucla.edu";
    public static final String STRING_TO_BE_TYPED_PASSWORD = "654321";
    ...
    public void failureLogin() {
        // Enter email and password of user that does not exist
        ...
        // Check that we are still in login page
