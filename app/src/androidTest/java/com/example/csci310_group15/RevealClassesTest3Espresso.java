...
public class RevealClassesTest3Espresso {
    ...
    public void revealClasses() {
        ...
        onView(withText(CLASS_TAB_202L)).perform(scrollTo()).check(matches(isDisplayed()));
        onView(withText(CLASS_TAB_250)).perform(scrollTo()).check(matches(isDisplayed()));
    }
}
